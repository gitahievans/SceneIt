    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center p-4">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-3/4 left-3/4 w-64 h-64 bg-indigo-400/20 rounded-full blur-3xl"></div>
            </div>
                ...
                <div className="bg-white/40 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 p-8 md:p-10">
                    ...
                    <form className="space-y-6">
                        <div className="space-y-2">
                           ...
                           text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500/50 
                           focus:border-green-400/50 transition-all duration-200 hover:bg-white/60"
                    ...
                    <div className="mt-8 text-center">
                        ...
                        <div className="mt-4">
                            <a href="/signup" className="inline-flex items-center gap-2 text-green-600 hover:text-green-700 font-semibold 
