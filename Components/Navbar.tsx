          ...
          <div className="flex items-center gap-3 md:gap-4">
            {user ? (
              <>
...

                {
                  navLinks.map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
                      className={`group relative flex items-center gap-2 px-4 py-2 border border-white/20 text-white rounded-xl font-semibold text-sm md:text-base transition-all duration-300 hover:bg-gray-600/30 hover:border-gray-400/50 hover:text-gray-200 hover:scale-105 active:scale-95 ${path === link.href ? "bg-orange-900 backdrop-blur-lg border-gray-400/50" : ""}`}
                    >
                ...
                <button
                  onClick={signOut}
                  className="group relative flex items-center gap-2 px-4 py-2 bg-red-500/25 backdrop-blur-sm border border-red-400/30 text-gray-200 rounded-xl font-semibold text-sm md:text-base transition-all duration-300 hover:bg-red-500/30 hover:border-red-400/50 hover:text-red-200 hover:scale-105 active:scale-95"
                >
