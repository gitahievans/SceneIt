    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center p-4">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 left-1/6 w-96 h-96 bg-purple-400/20 rounded-full blur-3xl animate-pulse"></div>
                <div className="absolute bottom-1/4 right-1/6 w-96 h-96 bg-blue-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
            ...
            <div className="relative w-full max-w-4xl">
                <div className="bg-white/40 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 p-8 md:p-12">
                    <div className="text-center mb-10">
                        ...
                        <div className="mt-6 flex items-center justify-center gap-2">
                            <div className="px-4 py-2 bg-white/50 backdrop-blur-sm rounded-full border border-white/60">
                                ...
                                <button
                                    ...
                                    className={`
                                        ...
                                        ${selected.includes(g.id)
                                            ...
                                            : 'bg-white/30 border-white/50 text-gray-700 hover:bg-white/50 hover:border-white/70'
                                        }
                                    `}
                                >
                    ...
                    <div className="text-center">
                        <button
                            ...
                            className={`
                                ...
                                ${loading || selected.length === 0
                                    ? 'bg-gray-300/50 border-gray-400/30 text-gray-500 cursor-not-allowed' 
                        ...
                        {selected.length === 0 && (
                            <p className="mt-4 text-sm text-gray-500 bg-white/30 backdrop-blur-sm rounded-lg px-4 py-2 inline-block border border-white/40">
