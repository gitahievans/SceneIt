          ...
          <div className="flex items-center justify-between h-16">
            ...
            {!loading && user && (
              <div className="hidden md:flex items-center space-x-4">
                ...
                <div className="flex items-center justify-center gap-2 px-3 py-2 bg-gray-200 dark:bg-gray-800 backdrop-blur-sm rounded-lg border border-gray-300/50 dark:border-gray-700/50">
                ...
                <button
                  onClick={signOut}
                  className="p-2 text-gray-700 bg-gray-200 hover:text-white hover:bg-red-500 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-red-500 dark:hover:text-white rounded-lg transition-all duration-200 border border-gray-300/50 dark:border-gray-700/50"
                  aria-label="Logout"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
