            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 h-[70vh] max-w-7xl mx-auto">
                <div className="col-span-1 md:col-span-2 relative rounded-2xl md:rounded-3xl overflow-hidden bg-gradient-to-br from-gray-900 to-black shadow-2xl group">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8 lg:p-10">
                        ...
                        <h1 className="text-lg md:text-2xl lg:text-3xl font-bold text-white mb-3 md:mb-6 leading-tight drop-shadow-lg clamp-1">
                            {mainMovie.title}
                        </h1>

                        <p className="text-sm md:text-base text-gray-200 mb-3 md:mb-6 line-clamp-2 md:line-clamp-3 max-w-2xl leading-relaxed drop-shadow-sm">
                            {mainMovie.overview}
                        </p>
